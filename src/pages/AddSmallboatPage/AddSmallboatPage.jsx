...
export default function AddSmallBoatPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const boatData = { category: "SmallBoat", length, beam, engine, power };

    try {
      const res = await axios.post("/ads/smallboats", {
        ...vehicleData,
        ...boatData,
      });
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit">Add Small Boat</button>
      </form>
